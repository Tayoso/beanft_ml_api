...
from dataplotsite.core.views import core
from dataplotsite.users.views import users
from dataplotsite.uploader.views import uploader
from dataplotsite.error_pages.handlers import error_pages
